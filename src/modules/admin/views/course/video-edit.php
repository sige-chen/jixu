...
<ol class="admin-breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="#">课程管理</a></li>
  <li class="breadcrumb-item"><a href="#">视频合集管理</a></li>
  <li class="breadcrumb-item"><a href="#">视频管理</a></li>
  ...
  <div class="card-body">
    <form method="post" enctype="multipart/form-data" action="<?php echo Url::to(['course/video-save']);?>">
      ...
      <div class="form-group">
        <label>视频文件</label>
        <video id="video-preview" controls="controls"></video>
      ...
      <div class="form-group">
        <label>视频封面</label>
        <img src="img/video-default-thumbnail.png" id="img-thumbnail">
